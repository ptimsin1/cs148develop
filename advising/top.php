...
<html lang="en">
    <head>
        <title>CS148 Advising Assignment</title>
        <meta charset="utf-8">
        <meta author="Prakriti Timsina" content="cs148, Advising Assignment,tables, courses, sections, techers">
        <meta description="The table allows you to create the four year plan" content="cs148,Advising Assignment, tables, courses, sections, techers">
        ...
        <?php
        $debug = false;//i changed this from true to false
